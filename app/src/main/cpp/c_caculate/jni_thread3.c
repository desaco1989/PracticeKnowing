...
#define JNIREG_CLASS "com/desaco/practiceknowing/native_method/JniThreadActivity"
// 全局变量
JavaVM *g_jvm = NULL;
jobject g_obj = NULL;
...
JNIEXPORT void JNICALL Java_com_desaco_practiceknowing_native_1method_JniThreadActivity_mainThread
 ...
 * Signature: ()V
 *//*不用JNI_OnLoad时的复杂命名方式 */
JNIEXPORT void JNICALL Java_com_desaco_practiceknowing_native_1method_JniThreadActivity_setJNIEnv
        (JNIEnv *env, jobject obj) {
    // 保存全局JVM以便在子线程中使用
