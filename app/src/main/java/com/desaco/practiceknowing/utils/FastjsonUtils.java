...
import com.desaco.practiceknowing.bean.Group;
import com.desaco.practiceknowing.bean.User;
import com.desaco.practiceknowing.bean.Weibo;
...
public class FastjsonUtils {//TODO 可以使用泛型对方法进行封装 Class<T>,instanceof
    /**
    ...
    public static void json2JsonObject(String json){
     ...
     */
    private static <T> void json2BeanM2(T obj) {
