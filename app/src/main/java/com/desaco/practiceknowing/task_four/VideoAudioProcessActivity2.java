...
public class VideoAudioProcessActivity2  extends Activity {
    private static final String SDCARD_PATH = Environment.getExternalStorageDirectory().getPath()+"/a_rtmp_video";
    ...
    MediaExtractor mediaExtractor;//媒体提取器
    MediaMuxer mediaMuxer;//媒体混合器
    ...
    private void exactorMedia() {
        ...
        try {
            ...
            mediaExtractor.setDataSource(SDCARD_PATH + "/vr1.mp4");
    ...
    private void muxerMedia() {
        ...
        try {
            ...
            // output_video  combie_audio_video.mp4
            mediaMuxer = new MediaMuxer(SDCARD_PATH + "/combie_audio_video.mp4", MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
    ...
    private void muxerAudio() {//分离音频 *.mp4
        mediaExtractor = new MediaExtractor();
        int audioIndex = -1;
        try {
            mediaExtractor.setDataSource(SDCARD_PATH + "/vr1.mp4");
            ...
            // 分离音频: output_audio ;  seprate_audio.mp3 或*.mp4
            mediaMuxer = new MediaMuxer(SDCARD_PATH + "/seprate_audio.mp3", MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
    ...
    private void combineVideo() {
        try {
            ...
            //output_video  combie_audio_video.mp4
            videoExtractor.setDataSource(SDCARD_PATH + "/combie_audio_video.mp4");
            ...
            //output ;combine_audio_video_new.mp4
            MediaMuxer mediaMuxer = new MediaMuxer(SDCARD_PATH + "/combine_audio_video_new.mp4", MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
